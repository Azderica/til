...
- 캐시가 신선한지 알려주기 위해서는 **캐시된 사본의 나이**와 **신선도 수명**을 알려주면 됩니다.
...
- 클라이언트와 서버의 시계가 다를 수도 있습니다. 이러한 문제는 발생하는 문제를 **클록 스큐**라고 부릅니다.
...
![캐시된 문서의 나이](https://user-images.githubusercontent.com/42582516/131253535-c3b0ed8b-ef43-4d44-b461-1d9e41351b1c.png)
...
- 이를 해결하기 위해 특정 URL에 대한 캐시 적중 횟수를 정기적으로 서버에게 돌려주는 `Meter`라고 하는 새 헤더 하나를 추가합니다.
