...
- 램포트 타임스탬프가 인과성에 일관적인 연산의 전체 순서를 정의하지만 분산 시스템의 곧ㅇ통 문제를 해결하는 데 아주 충분하지는 않습니다.
...
- 멤버십 서비스는 클러스터에서 어떤 노드가 현재 화렁화ㅣㄴ 살아 ㅣㅇㅅ는 멤버인지 결정합니다.
- 조드가 실제로는 살아 있지만 합의에 의해 죽은 것으로 잘못 선언될 가능성이 ㅇ씁니다.
