...
![간단한 암호화 프로그램](https://user-images.githubusercontent.com/42582516/147354775-e5b6898c-c9ad-4c07-b599-3a1547135184.png)
...
- 아키텍처 경계마다 경계 가까이 숨어 있는 험블 객체 패턴ㅇ르 발견할 수 있습니다.
...
- 모든 시스템에는 최소한 하나의 컴포넌트가 존재하고, 이 컴포넌트가 나머지 컴포넌트를 생성하고 조정하며 관리합니다. 이 컴포넌트를 메인(Main) 이라 부릅ㄴ디ㅏ.
...
- 테스트는 시스템 컴포넌트 중에 가장 고립되어 있습니다.
  - 테스트는 다른 모든 시스템 컴포넌트가 반드시 지켜야 하는 모델으ㅡㄹ 표현해줍니다.
